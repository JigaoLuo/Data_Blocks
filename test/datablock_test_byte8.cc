...
#ifdef DEBUG
TEST(DataBlock, 64bit_EQUAL_Random_Single_Vector_2_8) {
  size_t size = 1 << 8;
...
TEST(DataBlock, 64bit_EQUAL_Random_Single_Vector_2_16) {
  size_t size = 1 << 16;
  std::vector<std::vector<uint64_t>> int_table_portion(1);
  auto &col0 = int_table_portion[0];
  col0.reserve(size);
...
TEST(DataBlock, 64bit_GREAT_THAN_Random_Single_Vector_2_8) {
  size_t size = 1 << 8;
  std::vector<std::vector<uint64_t>> int_table_portion(1);
  auto &col0 = int_table_portion[0];
  col0.reserve(size);
...
TEST(DataBlock, 64bit_GREAT_THAN_Random_Single_Vector_2_16) {
  size_t size = 1 << 16;
  std::vector<std::vector<uint64_t>> int_table_portion(1);
  auto &col0 = int_table_portion[0];
  col0.reserve(size);
...
TEST(DataBlock, 64bit_LESS_THAN_Random_Single_Vector_2_8) {
  size_t size = 1 << 8;
  std::vector<std::vector<uint64_t>> int_table_portion(1);
  auto &col0 = int_table_portion[0];
  col0.reserve(size);
...
TEST(DataBlock, 64bit_LESS_THAN_Random_Single_Vector_2_16) {
  size_t size = 1 << 16;
  std::vector<std::vector<uint64_t>> int_table_portion(1);
  auto &col0 = int_table_portion[0];
  col0.reserve(size);
...
//
TEST(DataBlock, 64bit_BETWEEN_Random_Single_Vector_2_8) {
  size_t size = 1 << 8;
  std::vector<std::vector<uint64_t>> int_table_portion(1);
  auto &col0 = int_table_portion[0];
  col0.reserve(size);
...
TEST(DataBlock, 64bit_BETWEEN_Random_Single_Vector_2_16) {
  size_t size = 1 << 16;
  std::vector<std::vector<uint64_t>> int_table_portion(1);
  auto &col0 = int_table_portion[0];
  col0.reserve(size);
...
TEST(DataBlock, 64bit_MULTI_EQUAL_Random_Single_Vector_2_16) {
  size_t size = 1 << 16;
  size_t dup_size = 1 << 4;
  std::vector<std::vector<uint64_t>> int_table_portion(1);
  auto &col0 = int_table_portion[0];
  ...
  col0[0] = 0; col0[1] = UINT64_MAX;  // force to get higher encoding
...
TEST(DataBlock, 64bit_MULTI_GREATER_THAN_Random_Single_Vector_2_16) {
  size_t size = 1 << 16;
  size_t dup_size = 1 << 4;
  std::vector<std::vector<uint64_t>> int_table_portion(1);
  auto &col0 = int_table_portion[0];
...
TEST(DataBlock, 64bit_MULTI_LESS_THAN_Random_Single_Vector_2_16) {
  size_t size = 1 << 16;
  size_t dup_size = 1 << 4;
  std::vector<std::vector<uint64_t>> int_table_portion(1);
  auto &col0 = int_table_portion[0];
...
TEST(DataBlock, 64bit_MULTI_BETWEEN_Random_Single_Vector_2_16) {
  size_t size = 1 << 16;
  std::vector<std::vector<uint64_t>> int_table_portion(1);
  auto &col0 = int_table_portion[0];
  col0.reserve(size);
