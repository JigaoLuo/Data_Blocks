...
// ---------------------------------------------------------------------------------------------------
#ifdef DEBUG
TEST(Continuous_Memory_Segment_Scan, 16bit_EQUAL_Random_Single_Vector_2_8) {
/// Same as TEST(DataBlock, 16bit_EQUAL_Random_Single_Vector_2_8)
    size_t size = 1 << 8;
    ...
    scan_helper_unary_predicate<1, CompareType::EQUAL, SHIFT_BITS_BYTE2>(size, int_table_portion, cm, equal_to<uint64_t>());
}

TEST(Continuous_Memory_Segment_Scan, 16bit_EQUAL_Random_Single_Vector_2_16) {
    /// Same as TEST(DataBlock, 16bit_EQUAL_Random_Single_Vector_2_16)
    size_t size = 1 << 16;
    std::vector<std::vector<uint64_t>> int_table_portion(1);
    auto &col0 = int_table_portion[0];
    col0.reserve(size);
...
TEST(Continuous_Memory_Segment_Scan, 16bit_GREAT_THAN_Random_Single_Vector_2_8) {
    /// Same as TEST(DataBlock, 16bit_GREAT_THAN_Random_Single_Vector_2_8)
    size_t size = 1 << 8;
    std::vector<std::vector<uint64_t>> int_table_portion(1);
    auto &col0 = int_table_portion[0];
    col0.reserve(size);
    ...
    std::array<uint8_t, 0> str_index_arr{{}};
    cm.build_conti_memory_segment(std::move(db), schematypes, str_index_arr);
    scan_helper_unary_predicate<1, CompareType::GREATER_THAN, SHIFT_BITS_BYTE2>(size, int_table_portion, cm, greater<uint64_t>());
}

TEST(Continuous_Memory_Segment_Scan, 16bit_GREAT_THAN_Random_Single_Vector_2_16) {
    /// Same as TEST(DataBlock, 16bit_GREAT_THAN_Random_Single_Vector_2_16)
    size_t size = 1 << 16;
    std::vector<std::vector<uint64_t>> int_table_portion(1);
    auto &col0 = int_table_portion[0];
    col0.reserve(size);
...
TEST(Continuous_Memory_Segment_Scan, 16bit_LESS_THAN_Random_Single_Vector_2_8) {
    /// Same as TEST(DataBlock, 16bit_LESS_THAN_Random_Single_Vector_2_8)
    size_t size = 1 << 8;
    std::vector<std::vector<uint64_t>> int_table_portion(1);
    auto &col0 = int_table_portion[0];
    col0.reserve(size);
    ...
    std::array<uint8_t, 0> str_index_arr{{}};
    cm.build_conti_memory_segment(std::move(db), schematypes, str_index_arr);
    scan_helper_unary_predicate<1, CompareType::LESS_THAN, SHIFT_BITS_BYTE2>(size, int_table_portion, cm, less<uint64_t>());
}

TEST(Continuous_Memory_Segment_Scan, 16bit_LESS_THAN_Random_Single_Vector_2_16) {
    /// Same as TEST(DataBlock, 16bit_LESS_THAN_Random_Single_Vector_2_16)
    size_t size = 1 << 16;
    std::vector<std::vector<uint64_t>> int_table_portion(1);
    auto &col0 = int_table_portion[0];
    col0.reserve(size);
...
TEST(Continuous_Memory_Segment_Scan, 16bit_BETWEEN_Random_Single_Vector_2_8) {
    /// Same as TEST(DataBlock, 16bit_BETWEEN_Random_Single_Vector_2_8)
    size_t size = 1 << 8;
    std::vector<std::vector<uint64_t>> int_table_portion(1);
    auto &col0 = int_table_portion[0];
    col0.reserve(size);
    ...
    std::array<uint8_t, 0> str_index_arr{{}};
    cm.build_conti_memory_segment(std::move(db), schematypes, str_index_arr);
    scan_helper_binary_predicate<1, CompareType::BETWEEN, SHIFT_BITS_BYTE2>(size, int_table_portion, cm);
}

TEST(Continuous_Memory_Segment_Scan, 16bit_BETWEEN_Random_Single_Vector_2_16) {
    /// Same as TEST(DataBlock, 16bit_BETWEEN_Random_Single_Vector_2_16)
    size_t size = 1 << 16;
    std::vector<std::vector<uint64_t>> int_table_portion(1);
    auto &col0 = int_table_portion[0];
    col0.reserve(size);
...
TEST(Continuous_Memory_Segment_Scan, cm16bit_EQUAL_Random_Single_Vector_2_16) {
    size_t size = 1 << 16;
    size_t dup_size = 1 << 4;
    ...
    for (size_t i = 0; i < size; ++i) {
        uint64_t random1 = random.Rand() >> 48;
        uint64_t random2 = random.Rand() >> 48;
        uint64_t random3 = random.Rand() >> 48;
...
TEST(Continuous_Memory_Segment_Scan, cm16bit_GREATER_THAN_Random_Single_Vector_2_16) {
  size_t size = 1 << 16;
  size_t dup_size = 1 << 4;
  std::vector<std::vector<uint64_t>> table_portion(1);
  auto &col0 = table_portion[0];
...
TEST(Continuous_Memory_Segment_Scan, cm16bit_LESS_THAN_Random_Single_Vector_2_16) {
  size_t size = 1 << 16;
  size_t dup_size = 1 << 4;
  std::vector<std::vector<uint64_t>> table_portion(1);
  auto &col0 = table_portion[0];
...
TEST(Continuous_Memory_Segment_Scan, cm16bit_BETWEEN_Random_Single_Vector_2_16) {
  size_t size = 1 << 16;
  size_t dup_size = 1 << 4;
  std::vector<std::vector<uint64_t>> table_portion(1);
  auto &col0 = table_portion[0];
  ...
  for (size_t i = 0; i < size; ++i) {
    ...
    uint64_t random2 = random.Rand() >> 48;
    uint64_t random3 = random.Rand() >> 48;
    uint64_t random4 = random.Rand() >> 48;
    uint64_t random5 = random.Rand() >> 48;
    uint64_t random6 = random.Rand() >> 48;
